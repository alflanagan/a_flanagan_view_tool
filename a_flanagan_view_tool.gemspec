...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A copy of the Devcamp View Tool from Dissecting RoR course (udemy.com)}
  spec.description   = %q{Provides generated HTML data for a Rails application}
